...
int solve(string &w1, string &w2, int i, int j) {
    ...
    // reached end of word1 -> need to delete remaining characters of word2 to equalize || // reached end of word2 -> need to delete remaining characters of word1 to equalize
